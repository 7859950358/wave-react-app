        ...
        <div class="container mb-5 mb-md-6 mb-xl-10">
          <div class="row justify-content-md-center">
            <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center container">
              <h2 class="display-3 fw-bolder mb-4 tw-text-5xl sm:tw-text-1xl clas-res">You will get the <br/>perfect <span class="linear-g">resolutions</span> with our proficient services.</h2>
            </div>
          </div>
        </div>
        ...
        <div class="container overflow-hidden">
          <div class="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
            <div class="col-11 col-sm-6 col-lg-3">
              <div class="badge bg-color bsb-tpl-bg-yellow text-primary p-3 mb-4 ">
              ...
              <h4 class="mb-3 tw-text-2xl tw-font-bold">Market Research</h4>
            ...
            <div class="col-11 col-sm-6 col-lg-3">
              <div class="badge bg-color bsb-tpl-bg-green text-primary p-3 mb-4">
              ...
              <h4 class="mb-3 tw-text-2xl tw-font-bold">Web Design</h4>
            ...
            <div class="col-11 col-sm-6 col-lg-3">
              <div class="badge bg-color bsb-tpl-bg-pink text-primary p-3 mb-4">
              ...
              <h4 class="mb-3 tw-text-2xl tw-font-bold">SEO Services</h4>
            ...
            <div class="col-11 col-sm-6 col-lg-3">
              <div class="badge bg-color bsb-tpl-bg-cyan text-primary p-3 mb-4">
              ...
              <h4 class="mb-3 tw-text-2xl tw-font-bold">Content Marketing</h4>
